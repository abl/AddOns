...
L["Show Timber Nodes"] = "Поиск древесины" -- Needs review
...
L["Toggle showing timber nodes."] = "Вкл/Выкл показ древесины." -- Needs review
...
NL["Lumber Mill"] = "Лесопилка" -- Needs review
